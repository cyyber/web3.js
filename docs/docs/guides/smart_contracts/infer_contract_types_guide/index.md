...
(async function () {
	...
	const contract = new Contract(ERC20.abi, 'Q7af963cF6D228E564e2A0aA0DdBF06210B38615D', web3);
...
(async function() {
    ...
    const contract = new Contract(ERC20, "Q7af963cF6D228E564e2A0aA0DdBF06210B38615D", web3)
