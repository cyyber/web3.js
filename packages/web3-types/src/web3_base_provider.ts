...
export abstract class Web3BaseProvider<API extends Web3APISpec = QRLExecutionAPI>
...
export type SupportedProviders<API extends Web3APISpec = Web3QRLExecutionAPI> =
	| EIP1193Provider<API>
