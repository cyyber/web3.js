...
import { GREETER_DEPLOYMENT_DATA, GREETER_GREETING } from '../../fixtures/greeter';

describe('Web3QRL.call', () => {
	const expectedEncodedGreet = encodeParameter('string', GREETER_GREETING);
	const expectedDecodedGreet = GREETER_GREETING;
