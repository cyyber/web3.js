...
describe('hash', () => {
	...
	describe('encodePacked', () => {
		...
		it('enforces exact signed bounds and supports 512-bit integers', () => {
			expect(encodePacked({ type: 'int8', value: -128 })).toBe('0x80');
			expect(() => encodePacked({ type: 'int8', value: 128 })).toThrow(
