...
export class Web3Zond extends Web3Context<Web3ZondExecutionAPI, RegisteredSubscription> {
	 ...
	 *
	 * ```ts
	 * web3.zond.getBalance("Q407d73d8a49eeb85d32cf465507dd71d507100c1").then(console.log);
	 * > 1000000000000n
	 *
	 * web3.zond.getBalance("Q407d73d8a49eeb85d32cf465507dd71d507100c1").then(console.log);
	 * > "0xe8d4a51000"
	 ...
	 *
	 * ```ts
	 * web3.zond.getBlockTransactionCount("Q407d73d8a49eeb85d32cf465507dd71d507100c1").then(console.log);
	 * > 1n
	 *
	 ...
	 *
	 * ```ts
	 * web3.zond.getTransactionCount("Q407d73d8a49eeb85d32cf465507dd71d507100c1").then(console.log);
	 * > 1n
	 *
	 ...
	 * web3.zond.sign("0x48656c6c6f20776f726c64", "Q11f4d0A3c12e86B4b5F39B213F7E19D048276DAe").then(console.log);
	 * > "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400"
	 *
	 * // Using an unlocked account managed by connected RPC client
	 * web3.zond.sign("0x48656c6c6f20776f726c64", "Q11f4d0A3c12e86B4b5F39B213F7E19D048276DAe", { number: FMT_NUMBER.NUMBER , bytes: FMT_BYTES.UINT8ARRAY }).then(console.log);
	 * > Uint8Array(65) [
